...
Otrzymujemy niepokojące wpisy do dziennika, których nie jesteśmy autorem. Zadadnie kończy się dopiero po ukończeniu gry w VI. rozdziale.
...
Garvs mówi nam o kolejnej pladze topielców, której zgadzamy się pozbyć. Idziemy wzdłuż brzegu rzeki, co prowadzi do pojawienia się topielców. Zabijamy łącznie 10 sztuk, licznik pojawia nam się na ekranie i żeby ukończyć zadanie, trzeba Garvsowi dostarczyć jeszcze 4 skóry topielców.

## Smocze łuski 

__Zleca: Ocha__ 

Ocha mówi nam o tym, że zrobił pancerz z płytek pełzaczy i teraz chce spróbować wykonać taki ze smoczych łusek. Uczymy się ściągać płytki z pełzaczy, co jednocześnie umożliwia nam pozyskiwania smoczych łusek. Samego smoka spotkamy zaś dopiero w V. rozdziale, podczas wykonywania wątku głównego. Z łuskami wracamy do Ocha, czekamy dwa dni, a następnie możemy kupić pancerz za 5000 roperi. Jednocześnie, warte odnotowania jest to, że pancerz z płytek pełzaczy w cenie 3000 roperi można kupić u Garotha w Środkowej Dzielnicy po otrzymaniu informacji o tym od Ocha.
...
W pobliżu obozu bandytów (lokalizacja poniżej) spotykamy mężczyznę, który prosi nas o pomoc w wydostaniu się z tej okolicy. Dajemy mu zwój teleportacji na Farmę Karla, w podzięce w pobliżu gałęzi można wykopać pierścień lepkich rączek, który obdarza posiadacza umiejętnością kradzieży kieszonkowej, zadanie się kończy.
...
Lou chce sprzedać przetworzone ziele na wyspie, a my musimy udać się z nim, by pomóc w sprzedaży. Trafiamy najpierw do Portu, gdzie chodzimy do różnych imiennych i bezmiennych NPC, którzy nie są rekrutami i próbujemy im sprzedaż ziele. Lou chce, żebyśmy sprzedali tutaj 20 sztuk. Niektórzy wezmą po sztuce, dwóch, trzech, a niektórzy wcale. Następnie idziemy z Lou do Dolnej Dzielnicy, gdzie mamy sprzedać Mentuli hurtowo 15 sztuk ziela po 15 roperi. Jeśli chcemy więcej zarobić, możemy je sprzedać po 20. Kolejnym celem jest Środkowa Dzielnica, gdzie powtarzamy czynność z portu, tym razem mamy sprzedać 25 sztuk. Po sprzedaniu wystarczającej liczby ziela, zgłaszamy się do Lou, który mówi nam, że spotkamy się w Wolnym Obozie za jakiś czas. Czekamy dwie godziny i Lou powinien po naszej teleportacji pojawić się wewnątrz Wolnego Obozu. Tutaj musimy sprzedać ziela znowu 25 sztuk. Po zrobieniu tego, kierujemy się z Lou do Klasztoru, gdzie strażnik zabiera paczkę ziela. Musimy odzyskać ją, dostając się do magazynu na dziedzińcu. Można to zrobić poprzez kradzież klucza Sargonowi (44 zręczności), strażnikowi (70 zręczności), bądź sprowokować strażnika do walki i zdobyć klucz w ten sposób. Dodatkowo, jeśli gramy postacią maga, Sargon po prostu da nam klucz, pod warunkiem, że go odniesiemy. Niezależnie od podjętych działań, pociągamy za dźwignię, wchodzimy do magazynu i zabieramy paczkę ziela do Lou. W tym miejscu Lou rozlicza się z nami za wykonaną pracę i odbiera od nas 1325 roperi. Jeśli jakimś cudem nie mamy tej kwoty, Lou każe nam donieść ją w Obozie Bandytów.  
