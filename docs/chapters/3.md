...
Glen chce, abyśmy go wsparli w przeszukiwaniu pokojów orków. Strzelamy w przycisk za Glenem i podążamy wraz z nim do otwartego pomieszczenia. Teraz musimy przesunąć posąg orka. Tutaj gra mylnie sugeruje zamianę w chrząszcza, jednak ona nic nie daje. Idziemy do pokoju magów na parterze, w jednym z pokoi jest dźwignia do otwarcia wielkiej kraty. Ciągniemy za nią i idziemy do pokoju, Glen chce się rozejrzeć, potrzebuje godziny, my w tym czasie możemy przetrząsnąć okolicę. Używamy najpierw lewego, potem prawego kołowrotu i wracamy do Glena, który potrzebuje godziny na przeszukanie pokoju. Potem prosi nas o sprawdzenie teleportów, używamy ich, zabijamy orka i wracamy do Glena.
